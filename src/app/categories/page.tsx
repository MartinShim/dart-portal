...
const CATEGORIES: { group: string; desc: string; basis: string; tags: TagDef[] }[] = [
  {
    ...
    tags: [
      ...
      { tag: "연간 실적 상승", meaning: "연간 영업이익이 전년 대비 증가 (사업보고서, YoY)." },
      { tag: "연간 실적 하락", meaning: "연간 영업이익이 전년 대비 감소 (사업보고서, YoY)." },
      { tag: "영업이익 흑자전환(분기)", meaning: "연결 영업이익이 직전 분기(QoQ) 적자에서 당기 흑자로 전환. (사업보고서는 4분기 기준)" },
      { tag: "영업이익 흑자전환(연간)", meaning: "연간 연결 영업이익이 전년 적자에서 당기 흑자로 전환 (사업보고서, YoY)." },
      { tag: "영업이익 적자전환(분기)", meaning: "연결 영업이익이 직전 분기(QoQ) 흑자에서 당기 적자로 전환." },
      { tag: "영업이익 적자전환(연간)", meaning: "연간 연결 영업이익이 전년 흑자에서 당기 적자로 전환 (사업보고서, YoY)." },
