...
const CATEGORIES: { group: string; desc: string; basis: string; tags: TagDef[] }[] = [
  {
    ...
    tags: [
      ...
      { tag: "영업이익 흑자전환", meaning: "회사 전체(연결) 영업이익이 전년 동기 적자에서 당기 흑자로 전환." },
      { tag: "영업이익 적자전환", meaning: "회사 전체(연결) 영업이익이 전년 동기 흑자에서 당기 적자로 전환." },
  ...
  },
  {
    ...
    tags: [
      { tag: "영업이익 컨센서스 상회", meaning: "발표 영업이익이 증권사 컨센서스(추정 평균)를 상회 (표·서술엔 매출·영업이익·순이익 모두 표시, 태그는 영업이익만 기준)." },
      { tag: "영업이익 컨센서스 하회", meaning: "발표 영업이익이 컨센서스에 미달." },
      { tag: "흑자 전환", meaning: "적자 → 흑자로 전환. (턴어라운드 1단계)" },
      { tag: "흑자 전환 예상", meaning: "차기 흑자 전환이 예상되는 단계 (추정)." },
      { tag: "적자폭 축소", meaning: "적자가 지속되나 손실 규모가 축소되는 개선 국면." },
      { tag: "영업이익 10% 이상 성장", meaning: "영업이익 +10%~+30% 성장." },
      { tag: "영업이익 30% 이상 성장", meaning: "영업이익 +30% 이상 성장 (가장 강한 단계). 30%면 10%에도 포함되므로 가장 높은 단계를 부여." },
    ],
  },
  {
    group: "A-3. 안정성·재무건전성",
